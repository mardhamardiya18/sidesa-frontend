    ...
    <div class="flex flex-col w-[calc(525/1000*100%)] shrink-0 gap-[14px]">
      ...
      >
        ...
        <div class="flex flex-col gap-[14px]">
          <div
            v-for="(item, index) in headOfFamily.family_members"
            :key="index"
      ...
      <div class="flex flex-col p-4 gap-3">
        ...
        <div class="flex items-center gap-3">
          ...
          >
            ...
            <span v-if="!loading" class="font-semibold text-sm text-white"
              >Iya Hapus</span
            >
            <span v-else class="font-semibold text-sm text-white"
              >Loading...</span
            >
          </button>
        </div>
...
const { loading, headOfFamily } = storeToRefs(headOfFamilyStore);
